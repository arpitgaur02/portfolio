...
//     /* 4. Align Links to LEFT - UPDATED FOR TEXT BUTTONS */
//     .project-links {
//       display: flex;
//       align-items: center;
//       position: relative;
...
//     {
//       featured: allMarkdownRemark(
//         filter: { fileAbsolutePath: { regex: "/content/featured/" }, frontmatter: { featured: { eq: true } } }
//         sort: { fields: [frontmatter___date], order: DESC }
//       ) {
//         edges {
//           node {
